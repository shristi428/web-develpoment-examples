...
<form action="" method="GET">
      ...
      <input type="text" name="roll" placeholder="Roll No"></input>
      <input type="text" name="maths" placeholder="Maths"></input>
	  <input type="text" name="science" placeholder="Science"></input>
	  <input type="text" name="eng" placeholder="English"></input>
	  <input type="text" name="lang" placeholder="Language"></input>
	  <input type="text" name="moral" placeholder="Moral_science"></input>
...
if(isset($_GET['submit'])){
	...
	$avg=0;
	$grade=null;
	$marks=array("maths"=>$_GET['maths'],"science"=>$_GET['science'],"english"=>$_GET['eng'],"Languages"=>$_GET['lang'],"Moral_science1"=>$_GET['moral']);
	
	echo"Your name is ".$stuname,"<br>";
	echo"Your Roll No is ".$sturoll."<br>";
	echo"Marks of the  student is<br>";
	echo"Maths:-".$marks["maths"]."<br>";
	echo"Science:-".$marks["science"]."<br>";
	echo"English:-".$marks["english"]."<br>";
	echo"Language:-".$marks["Languages"]."<br>";
	echo"Moral_science:-".$marks["Moral_science1"]."<br>";
	
	$total=$marks["maths"]+$marks["science"]+$marks["english"]+$marks["Languages"]+$marks["Moral_science1"];
	
	echo"Total of the marks is ".$total."<br>";
	
	$avg=$total/5;
	
	echo"Avarage of the marks is ".$avg."<br>";
	...
	echo"Grade of the student is ".$grade;	}
	Calgrade($avg);
}?>
</div>
<div  class="alignright right">
<?php 
show_source("Exp04ques06.php");
?>
</div>
