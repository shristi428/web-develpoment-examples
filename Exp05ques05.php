...
<input type="text" name="Id" placeholder=" Course ID"></br>
<input type="text" name="weight" placeholder="Weightage"></br>
<input type="text" name= "no." placeholder="No. of classes"></br>
<input type="submit" name="submit"></br>
<input type="submit" name="show"></br>

<?php
is(isset($_GET['submit']))
{
	$cour=$_GET['course'];
	$id=$_GET['Id'];
	$wei=$_GET['weight'];
	...
	if(file_exists("courseplan.txt")){
		$fp=fopen("courseplan.txt",'a');
		fwrite($fp,"Course:-$cour\r\n");
		fwrite($fp,"ID:-$id\r\n");
		fwrite($fp,"Weightage:-$wei\r\n");
		fwrite($fp,"number of classes:-$numb\r\n");
	echo " Record added sucessfully ";
	}
	
	else{
		$fp=fopen("courseplan.txt",'w+');
			$fp=fopen("courseplan.txt",'a');
		fwrite($fp,"Course:-$cour\r\n");
		fwrite($fp,"ID:-$id\r\n");
		fwrite($fp,"Weightage:-$wei\r\n");
	...
	$str=file_get_contents("courseplan.txt");
	$a=explode("\r\n",$str);
