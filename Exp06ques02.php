...
function change(){
	...
	document.getElementById("pic1").src="back1.jpg";
}
function change1(){
	document.getElementById("pic1").src="back.jpg";
}
</script>
</head>
<body>
...
<div class="centered">
<img src="back.jpg" id="pic1" onmouseover="change()" onmouseout="change1()"width="1500px" height="1500px">
</div>
  <div  class="alignright right">
  <?php 
show_source("Exp06ques02.php");
?>
</div>  
